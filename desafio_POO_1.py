...
# Bloco de execução para interagir com o sistema

cliente1 = PessoaFisica("João da Silva", "01/01/1985", "123.456.789-00", "Rua A, 123")
conta1 = ContaCorrente.nova_conta(cliente1, numero=1001)
...
# Tentativa de Saque que excede o limite
print("\n--- Tentativa de Saque com valor acima do limite ---")
saque_grande = Saque(600)
cliente1.realizar_transacao(conta1, saque_grande)
print(f"Saldo atual: R$ {conta1.saldo:.2f}")
